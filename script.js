...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (hamburger && navLinks) {
        ...
        // Improved: Only close menu when open and clicking outside (on mobile)
        document.addEventListener('click', function(e) {
            const isMenuOpen = hamburger.classList.contains('active') && navLinks.classList.contains('active');
            // Only close if menu is open, and click is outside hamburger/navLinks, and screen is mobile size
            if (
                isMenuOpen &&
